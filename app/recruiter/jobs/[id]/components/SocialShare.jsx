          ...
          >
            <Menu.Item>
              <a
                ...
                target="_blank"
                className="flex w-full cursor-pointer items-center gap-2 bg-white p-4 text-center text-sm font-medium text-gray-700 duration-300 first:rounded-t-sm last:rounded-b-sm hover:bg-secondary/80 hover:text-primary"
              >
                <div>
